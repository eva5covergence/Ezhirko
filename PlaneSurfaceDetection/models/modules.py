    ...
    if 'normal' in config.ANCHOR_TYPE:
        ...
        if config.NUM_PARAMETER_CHANNELS == 4:
            ...
            if config.FITTING_TYPE % 2 == 1:
                ...
                print('param',plane_parameters)
                print('Plane Shape:',plane_parameters.shape)
                print('---------------------------------------')
                print('param',plane_parameter_uncertainitiy)
                print('Plane Shape:',plane_parameter_uncertainitiy.shape)
