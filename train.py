...
from ppe_multimodel_net import PPENet
...
try:  # Mixed precision training https://github.com/NVIDIA/apex
    ...
    mixed_precision = False  # not installedCO
...
yolo_weights_mapping = {'yolo2_learner_s3.0.weight': 'module_list.106.Conv2d.weight', 'yolo2_learner_s3.1.weight': 'module_list.106.BatchNorm2d.weight', 'yolo2_learner_s3.1.bias': 'module_list.106.BatchNorm2d.bias', 'yolo2_learner_s3.3.weight': 'module_list.107.Conv2d.weight', 'yolo2_learner_s3.4.weight': 'module_list.107.BatchNorm2d.weight', 'yolo2_learner_s3.4.bias': 'module_list.107.BatchNorm2d.bias', 'yolo2_learner_s3.6.weight': 'module_list.103.Conv2d.weight', 'yolo2_learner_s3.7.weight': 'module_list.103.BatchNorm2d.weight', 'yolo2_learner_s3.7.bias': 'module_list.103.BatchNorm2d.bias', 'yolo2_learner_s3.9.weight': 'module_list.109.Conv2d.weight', 'yolo2_learner_s3.10.weight': 'module_list.109.BatchNorm2d.weight', 'yolo2_learner_s3.10.bias': 'module_list.109.BatchNorm2d.bias', 'yolo2_learner_s3.12.weight': 'module_list.108.Conv2d.weight', 'yolo2_learner_s3.13.weight': 'module_list.108.BatchNorm2d.weight', 'yolo2_learner_s3.13.bias': 'module_list.108.BatchNorm2d.bias', 'yolo2_learner_s3.15.weight': 'module_list.111.Conv2d.weight', 'yolo2_learner_s3.16.weight': 'module_list.111.BatchNorm2d.weight', 'yolo2_learner_s3.16.bias': 'module_list.111.BatchNorm2d.bias', 'yolo2_learner.0.weight': 'module_list.112.Conv2d.weight', 'yolo2_learner.0.bias': 'module_list.112.Conv2d.bias', 'yolo3_learner_s3.0.weight': 'module_list.94.Conv2d.weight', 'yolo3_learner_s3.1.weight': 'module_list.94.BatchNorm2d.weight', 'yolo3_learner_s3.1.bias': 'module_list.94.BatchNorm2d.bias', 'yolo3_learner_s3.3.weight': 'module_list.95.Conv2d.weight', 'yolo3_learner_s3.4.weight': 'module_list.95.BatchNorm2d.weight', 'yolo3_learner_s3.4.bias': 'module_list.95.BatchNorm2d.bias', 'yolo3_learner_s3.6.weight': 'module_list.91.Conv2d.weight', 'yolo3_learner_s3.7.weight': 'module_list.91.BatchNorm2d.weight', 'yolo3_learner_s3.7.bias': 'module_list.91.BatchNorm2d.bias', 'yolo3_learner_s3.9.weight': 'module_list.97.Conv2d.weight', 'yolo3_learner_s3.10.bias': 'module_list.97.BatchNorm2d.bias', 'yolo3_learner_s3.12.weight': 'module_list.96.Conv2d.weight', 'yolo3_learner_s3.13.weight': 'module_list.96.BatchNorm2d.weight', 'yolo3_learner_s3.13.bias': 'module_list.96.BatchNorm2d.weight', 'yolo3_learner_s3.15.weight': 'module_list.99.Conv2d.weight', 'yolo3_learner_s3.16.weight': 'module_list.99.BatchNorm2d.weight', 'yolo3_learner_s3.16.bias': 'module_list.99.BatchNorm2d.bias', 'yolo3_learner.0.weight ': 'module_list.100.Conv2d.weight', 'yolo3_learner.0.bias': 'module_list.100.Conv2d.bias', 'yolo4_learner.0.weight': 'module_list.88.Conv2d.weight', 'yolo4_learner.0.bias': 'module_list.88.Conv2d.bias'}
...
def print_summary(network,title,input_size=(3,416,416)):
  print(title)
  summary(network,input_size=input_size)

def load_my_state_dict(state_dict, model):
    own_state = model.named_parameters()
...
def train():
    ...
    print(f"imgsz_min- {imgsz_min}, imgsz_max- {imgsz_max}, imgsz_test- {imgsz_test}")
        ...
        if init_train=='True':
            ...
            for k,v in model_dict.items():
                if k in yolo_weights_mapping.keys():
                    model_dict[k]=yolo_chkpt['model'][yolo_weights_mapping[k]]
            # 3. load the new state dict
            model.load_state_dict(model_dict)
    ...
    #     print(name)
    #     print(param.requires_grad)
    print_summary(model,'YMP Model Summary',input_size=(3,opt.img_size[0],opt.img_size[0]))
    # Start training
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        print(('\n' + '%17s' * 10) % ('Epoch', 'gpu_mem', 'GIoU', 'obj', 'cls', 'total', 'targets', 'ImgSize', 'RmseGradMeanLoss', 'SSIM_meanLoss'))
        pbar = tqdm(enumerate(dataloader), total=nb)  # progress bar
        for i, (imgs, targets, paths, _,depth_targets,_,_) in pbar:  # batch -------------------------------------------------------------
            ...
            if midasnet_freeze=='False':
                ...
                rmse_gradient_mean_loss, ssim_mean_loss = [depth_lambda * item for item in compute_depth_loss(depth_preds, depth_targets, batch_size, device)]
            ...
            if not torch.isfinite(loss):
                print('WARNING: non-finite loss, ending training ', loss_items, rmse_gradient_mean_loss, ssim_mean_loss)
                return results
            ...
            s = ('%10s' * 2 + '%17.3g' * 8) % ('%g/%g' % (epoch, epochs - 1), mem, *mloss, len(targets), img_size, rmse_gradient_mean_loss, ssim_mean_loss)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_weights', type=str, default='', help='initial weights path')
    parser.add_argument('--midas_weights', type=str, default='', help='initial weights path')
    parser.add_argument('--weights', type=str, default='', help='initial weights path')
    parser.add_argument('--name', default='', help='renames results.txt to results_name.txt if supplied')
    parser.add_argument('--device', default='', help='device id (i.e. 0 or 0,1 or cpu)')
    parser.add_argument('--adam', action='store_true', help='use adam optimizer')
    parser.add_argument('--single-cls', action='store_true', help='train as single-class dataset')
    parser.add_argument('--init_train', default='False', help='Make it True for initial training to load original or trained yolo weights')
    parser.add_argument('--midasnet_freeze', default='False', help='Freeze the midasnet. Default is False')
    parser.add_argument('--yolo_freeze', default='False', help='Freeze the yolo branch. Default is False')
    parser.add_argument('--bbox_lambda', type=float, default=1,  help='weightage for bbox loss')
    parser.add_argument('--depth_lambda', type=float, default=1,  help='weightage for depth image prediction loss')
